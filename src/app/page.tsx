  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      `}</style>
        ...
        <div className="w-full max-w-4xl rounded-xl shadow-lg p-6 md:p-8">
          <BookBanner
            title="CKS Handbook - 2nd Edition"
            description="Updated to align with the latest CKS exam changes introduced in October 2024."
            ctaText="Get a copy!"
            ctaLink="https://cks.purutuladhar.com"
          />
        </div>
